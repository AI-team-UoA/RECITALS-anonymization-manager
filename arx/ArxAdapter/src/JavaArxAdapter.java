...
public class JavaArxAdapter {
    ...
    public ARXResult makeAnonymous(Integer k, Integer l, Double t, Double suppression_limit, String output_path) {
        try {
            ...
            HashMap<String, Integer> gen_levels = new HashMap<String, Integer>();
            for (String qid : quasi_identifiers) {
                int gen_level = out.getGeneralization(qid);
                gen_levels.put(qid, gen_level);
            }
    ...
    public static void main(String[] args) {
        System.out.println("This is a Java ARX adapter.");
    }
}